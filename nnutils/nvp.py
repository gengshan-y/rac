"""
https://raw.githubusercontent.com/JiahuiLei/CaDeX/master/core/net_bank/nvp_v2/models/nvp_v2_5.py
"""
import pdb
import torch
...
class CouplingLayer(nn.Module):
    ...
    def forward(self, F, y):
        ...
        s = self.map_s(F_y1)
        t = self.map_t(F_y1)
        #s = self.map_s(F_y1)*0.1
        #t = self.map_t(F_y1)*0.01
    ...
    def inverse(self, F, x):
        ...
        s = self.map_s(F_x1)
        t = self.map_t(F_x1)
        #s = self.map_s(F_x1)*0.1
        #t = self.map_t(F_x1)*0.01
